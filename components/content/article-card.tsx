...
export function ArticleCard({ href, title, summary, label }: { href: string; title: string; summary: string; label: string }) {
  return (
    <Link href={href} className="group block rounded-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
